    ...
    <div id="works" className=" mx-auto m-auto h-[300px]  mt-16 sm:h-[250px]">
      <div className=" bg-yellow-400 h-full flex flex-col gap-8 items-center justify-between p-10 sm:p-7">
        ...
        <div className=" flex items-center justify-center gap-8 sm:gap-5">
          ...
          href ="https://www.linkedin.com/in/karthikraj-s"
          ...
          href ="https://www.skillrack.com/faces/ui/profile.xhtml"
            className="box font-medium text-white  flex items-center justify-center flex-col"
          >
            <IoLogoWhatsapp className=" text-black text-3xl hover:scale-125 cursor-pointer" />
            <p>SKillRank</p>
          ...
          href ="https://instagram.com/sr___karthik"
            className="box font-medium text-white  flex items-center justify-center flex-col"
          >
